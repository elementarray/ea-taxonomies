 ...
 * @author William Holt
 */
class Autoloader { /** eaTaxonomies_Autoloader **/
    /**
	...
	// echo '==DEBUG== Autoloader registering... ==DEBUG==</br>';
     ...
     *
     * @param string $class_name // was $class...
    ...
    // If the specified $class_name does not include our namespace move on to the next iteration.
	if ( false === strpos( $class_name, 'EA_Taxonomies' ) ) {
		return;
	}
